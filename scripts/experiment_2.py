...
strumien1 = StreamGenerator(random_state=66, n_chunks=88,
                            chunk_size=25, n_classes=4,
                            n_features=10, n_informative=2,
                            n_redundant=0, n_clusters_per_class=1)

strumien2 = StreamGenerator(random_state=66, n_chunks=88,
                            chunk_size=25, n_classes=4,
                            n_features=10, n_informative=2,
                            n_redundant=0, n_clusters_per_class=1)

strumien3 = StreamGenerator(random_state=66, n_chunks=88,
                            chunk_size=25, n_classes=4,
                            n_features=10, n_informative=2,
                            n_redundant=0, n_clusters_per_class=1)


model1 = IncrKmeans(k=4, random_state=66)   # Inicjalizacja modelu Incremental KMeans
model2 = AlgMiniBatchKMeans(n_clusters=4, random_state=66)  # Inicjalizacja modelu Mini-Batch KMeans
model3 = AlgBirch(n_clusters=4, random_state=66)    # Inicjalizacja modelu BIRCH
...
with open('../results/results2.npy', 'r') as x:
    print(x.read())
