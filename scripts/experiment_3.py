...
strumien1 = StreamGenerator(random_state=50, n_chunks=100,
                            chunk_size=10, n_classes=3,
                            n_features=10, n_informative=2,
                            n_redundant=0, n_clusters_per_class=1)

strumien2 = StreamGenerator(random_state=50, n_chunks=100,
                            chunk_size=10, n_classes=3,
                            n_features=10, n_informative=2,
                            n_redundant=0, n_clusters_per_class=1)

strumien3 = StreamGenerator(random_state=50, n_chunks=100,
                            chunk_size=10, n_classes=3,
                            n_features=10, n_informative=2,
                            n_redundant=0, n_clusters_per_class=1)


model1 = IncrKmeans(k=3, random_state=50)   # Inicjalizacja modelu Incremental KMeans
model2 = AlgMiniBatchKMeans(n_clusters=3, random_state=50)  # Inicjalizacja modelu Mini-Batch KMeans
model3 = AlgBirch(n_clusters=3, random_state=50)    # Inicjalizacja modelu BIRCH
...
with open('../results/results3.npy', 'r') as x:
    print(x.read())
